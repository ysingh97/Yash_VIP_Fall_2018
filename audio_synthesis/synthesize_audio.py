...
def interpolate(recordedAudio, instrument):
    ...
    # fastgen.synthesize(crossfade(enc1, enc2), checkpoint_path='../wavenet-ckpt/model.ckpt-200000', save_paths=['crossfade.wav'])
...
def experiment():
    ...
    # synthesizeEncodings("recording3", "cello", voiceEncoding, celloEncoding, 1.0, 1.0)
    # synthesizeEncodings("recording3", "cello", voiceEncoding, celloEncoding, 1.1, 1.0)
    # synthesizeEncodings("recording3", "cello", voiceEncoding, celloEncoding, 1.2, 1.0)
    # synthesizeEncodings("recording3", "cello", voiceEncoding, celloEncoding, 1.3, 1.0)
    # synthesizeEncodings("recording3", "cello", voiceEncoding, celloEncoding, 1.4, 1.0)
    # # synthesizeEncodings("recording3", "drums", voiceEncoding, drumEncoding, 1.0, 1.0)
    # synthesizeEncodings("recording3", "drums", voiceEncoding, drumEncoding, 1.1, 1.0)
    # synthesizeEncodings("recording3", "drums", voiceEncoding, drumEncoding, 1.2, 1.0)
    # synthesizeEncodings("recording3", "drums", voiceEncoding, drumEncoding, 1.3, 1.0)
    # synthesizeEncodings("recording3", "drums", voiceEncoding, drumEncoding, 1.4, 1.0)
    # synthesizeEncodings("recording3", "cello", voiceEncoding, celloEncoding, 1.5, 1.0)
    # synthesizeEncodings("recording3", "cello", voiceEncoding, celloEncoding, 1.6, 1.0)
    # synthesizeEncodings("recording3", "cello", voiceEncoding, celloEncoding, 1.7, 1.0)
    # synthesizeEncodings("recording3", "drums", voiceEncoding, drumEncoding, 1.5, 1.0)
    # synthesizeEncodings("recording3", "drums", voiceEncoding, drumEncoding, 1.6, 1.0)
    # synthesizeEncodings("recording3", "drums", voiceEncoding, drumEncoding, 1.7, 1.0)
...
# for now we use recordings made on another computer
